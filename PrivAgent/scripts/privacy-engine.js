...
(function (root) {
  ...
  function addBadge(el, type) {
    ...
    badge.textContent = `\uD83D\uDD12 ${labelFor(type)}`;
    Object.assign(badge.style, {
      position: 'absolute', fontSize: '10px', fontFamily: 'Segoe UI, Arial, sans-serif',
      fontWeight: '700', letterSpacing: '0.3px', color: '#00E5FF',
      background: 'rgba(6, 20, 30, 0.92)', border: '1px solid rgba(0, 229, 255, 0.5)',
      borderRadius: '4px', padding: '2px 6px', zIndex: 2147483647,
      pointerEvents: 'none', whiteSpace: 'nowrap', boxShadow: '0 0 6px rgba(0,229,255,0.35)'
    });
